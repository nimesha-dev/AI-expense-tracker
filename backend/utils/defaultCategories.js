export const defaultCategories = [
    ...
    { name: 'Shopping', type: 'expense', icon: 'shopping-bag', color: '#885CF6' },
    { name: 'Healthcare', type: 'expense', icon: 'heart', color: '#3882F6' },
    ...
    { name: 'Other Expense', type: 'expense', icon: 'more-horizontal', color: '#647488' },
];
